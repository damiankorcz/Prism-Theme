    ...
    grunt.initConfig({
        ...
        watch: {
            css: {
                ...
                tasks: ['env','sass:unminified','sass:dist','cssmin','concat_css','copy',] // Runs the following tasks in the specified order when there is a change detected to the Watched files.
            }
        }
    });
